...
<div class="bg-white border-2 my-8 mx-auto rounded-lg shadow-lg p-8 w-full max-w-md">
    ...
    <form id="signup-form" action=<?= URLROOT . '/users/register'?> method="POST" class="flex flex-col gap-6">
        ...
        <div>
            ...
            <input type="text" id="firstname" name="firstname" class="w-full px-4 py-2 border rounded-lg outline-none focus:ring-2 focus:ring-primary" placeholder="Enter your first name">
        </div>
        
        <div>
            <label for="lastname" class="block text-sm font-semibold text-secondary mb-1">Last Name</label>
            <input type="text" id="lastname" name="lastname" class="w-full px-4 py-2 border rounded-lg outline-none focus:ring-2 focus:ring-primary" placeholder="Enter your last name">
        </div>
        ...
        <div>
            ...
            <input type="password" id="confirm-password" name="confirm-password" class="w-full px-4 py-2 border rounded-lg outline-none focus:ring-2 focus:ring-primary" placeholder="Confirm your password">
        </div>
