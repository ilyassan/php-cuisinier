        ...
        <form action="" class="sm:w-1/2">
            ...
            ?>
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="bg-[#eee] rounded-md px-2 py-1.5 outline-tertiary"><?=$dish["name"]?></div>
                    </div>
            <?php
                }
            ?>
            ...
            <div class="flex gap-5">
                <button class="flex mt-8 w-fit items-center gap-3 bg-tertiary px-2 py-1 rounded-lg text-based">Edit</button>
                <button class="flex mt-8 w-fit items-center gap-3 bg-red-400 text-red-800 px-2 py-1 rounded-lg">Delete</button>
            </div>
        </form>
    </div>
</section>
