<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){           
        ...
        if (empty($errors['menu_id_err']) && empty($errors['reservation_datetime_err'])) {
            if (updateReservation($id ,$reservation["menu_id"], $reservation["guests"], $reservation["reservation_datetime"])) {
                flash("success", "Reservation has been updated successfully.");
                redirect("show-reservation", $id);
                return;
            }else{
...
<section class="pt-10 pb-20">
    ...
    <div class="container flex flex-col sm:flex-row justify-center gap-20 sm:gap-14">
        ...
        <form id="menu-form" method="POST" action="" class="sm:w-1/2">
