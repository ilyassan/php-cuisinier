    ...
    <div class="container flex flex-col sm:flex-row justify-center gap-20 sm:gap-14">
        ...
        <div class="sm:w-1/2">
            ...
            <div class="flex gap-5">
                <a href=<?= URL. "/edit-reservation.php?id=" . $reservation["id"] ?> class="flex cursor-pointer mt-8 w-fit items-center gap-3 bg-tertiary px-2 py-1 rounded-lg text-based">Edit</a>
                <form action=<?= URL. "/delete-reservation.php?id=" . $reservation["id"] ?> method="POST">
