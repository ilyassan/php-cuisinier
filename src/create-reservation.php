        ...
        <form action="" class="sm:w-1/2">
            <div class="flex flex-col gap-6">
                <div class="relative flex flex-col gap-1">
                    ...
                    <div id="menus" class="flex hidden overflow-hidden absolute top-[110%] z-10 bg-[#eee] rounded-lg w-full flex-col">
                    </div>
                </div>
                <div class="flex flex-col gap-1">
                    <label for="dish2" class="font-bold">Number of guests:</label>
                    <input type="number" class="bg-[#eee] rounded-md px-2 py-1.5 outline-tertiary" min="1" placeholder="Number of guests">
                </div>
                <div class="flex flex-col gap-1">
                    <label for="dish3" class="font-bold">Date of feast:</label>
                    <input type="date" class="bg-[#eee] rounded-md px-2 py-1.5 outline-tertiary">
                </div>
            </div>
